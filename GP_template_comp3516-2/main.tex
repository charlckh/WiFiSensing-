...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%% YOUR NAME %%%%%%%%%%%%%%%%%%%%%%%%%%%
\author{Lam Pak Hei Jason}
\email{jasonlph@connect.hku.hk}
\affiliation{%
    \institution{grab some data}
    \city{Hong Kong}
    \country{}
}

\author{Ng Ching Ngai}
\email{alexng04@connect.hku.hk}
\affiliation{%
    \institution{grab some data}
    \city{Hong Kong}
    \country{}
